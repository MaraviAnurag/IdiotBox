package com.merakiworks.idiotbox.fragment;
...
import com.merakiworks.idiotbox.adapter.TvShowAdapter;
...
import static com.merakiworks.idiotbox.other.Contract.API_IMAGE_URL;
        ...
        StringRequest stringRequestTvShowDetails = new StringRequest(Request.Method.GET, tvShowDetailsRequest,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Log.i(TAG, "onResponse(TvShowLatest): " + response);
                        try {
